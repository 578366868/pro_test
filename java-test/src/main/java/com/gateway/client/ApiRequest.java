...
public class ApiRequest {
    ...
    private String interactionTimeoutUrl;
    ...
    public String getInteractionTimeout() {
        return interactionTimeout;
    }

    public void setInteractionTimeout(String interactionTimeout) {
        this.interactionTimeout = interactionTimeout;
    }

    public String getInteractionTimeoutUrl() {
        return interactionTimeoutUrl;
    }

    public void setInteractionTimeoutUrl(String interactionTimeoutUrl) {
        this.interactionTimeoutUrl = interactionTimeoutUrl;
    }
}