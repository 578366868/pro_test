...
public class WebController {
    ...
    public ModelAndView showHostedCheckout(HttpSession session, HttpServletRequest request) {
        ModelAndView mav = new ModelAndView();
        ...
        if (StringUtils.isNotEmpty(orderId)) {
            ...
            orderId = Utils.createUniqueId("order-");
            req.setOrderId(orderId);
            req.setOrderCurrency(config.getCurrency());
            req.setOrderAmount("0.01");
            req.setInteractionOperation("AUTHORIZE");
            req.setInteractionTimeout("600");
            req.setInteractionTimeoutUrl("https://www.baidu.com");
            ...
            try {
                ...
                session.setAttribute("orderId", req.getOrderId());
                session.setAttribute("hostedSession", hostedSession);
